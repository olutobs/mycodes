...
<h1>Please sign in below</h1>
 ...
 <form method="post" action="">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="Name" class="form-control" id="inputname" placeholder="Please enter your name" name="name_input">
    </div>
  </div>
    
    
     <button type="submit" name="submit" class="btn btn-secondary"> Take to next page</button>
